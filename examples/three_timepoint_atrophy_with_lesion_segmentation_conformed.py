...
conform_baseline = pe.Node( name = 'conform_baseline', 
                                                            interface = MRIConvert())
conform_baseline.inputs.conform = True

conform_fu1 = pe.Node( name = 'conform_fu1', 
                                       interface = MRIConvert())
conform_fu1.inputs.conform = True

conform_fu2 = pe.Node( name = 'conform_fu2', 
                                       interface = MRIConvert())
conform_fu2.inputs.conform = True
...
workflow.connect([
                  ...
                  (file_selector, conform_baseline,
                  [('baseline_t1', 'in_file' )]
                  ),
                  (conform_baseline, bet_baseline,
                  [('out_file', 'in_file' )]
                  ),
                  (file_selector, conform_fu1,
                  [( 'fu1_t1', 'in_file' )]
                  ),
                  (conform_fu1, bet_fu1,
                  [( 'out_file', 'in_file' )]
                  ),
                  (file_selector, conform_fu2,
                  [( 'fu2_t1', 'in_file' )]
                  ),
                  (conform_fu2, bet_fu2,
                  [( 'out_file', 'in_file' )]
                  ...
                  (binarise_fu2, lesion_filler_fu2,
                  [('out_file', 'lesion_mask')]
                  ),
