...
templates = {{
            ...
            "fu3_t2_lesion" :  '/cluster/project0/MS_LATA/fourd/patients/{{subject_id}}/{fu3_t2_lesion_mask_nii_gz}',
            }}
...
brain_steps_fu3.inputs.steps_mask = 'brain_steps_fu3_mask.nii.gz'
...
workflow.connect([
                  ...
                  (file_selector, regt2maskt1_fu3,
                  [('fu3_t2_lesion', 'in_file')]
                  ),
